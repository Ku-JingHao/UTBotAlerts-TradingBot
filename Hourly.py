    ...
    for phone_number in WHATSAPP_PHONE_NUMBERS:
        try:
            ...
            kit.sendwhatmsg_instantly(
                phone_number, 
                message,
                wait_time=40,  # Reduced wait time
                tab_close=True,  # Automatically close the tab after sending
                close_time=10   # Reduced close time
            )
...
ALPACA_API_KEY = "PKZG8ERG6D05QJYRDAFW"
ALPACA_SECRET_KEY = "orqlLXRhGZkol8UOBWTH07skoZaneOoko8JSDQKH"
