...
ALPACA_API_KEY = "PKI5X3KKYE8L3B8FKHDB"
ALPACA_SECRET_KEY = "b5uA0pfG0EkgSwnyLcU8LXBYeHxumBRuUepDqqan"
    ...
    if trade_history:
        ...
        if current_position > 0:
            ...
            try:
                ...
                logger.info(f"Open position  : {current_position} SUSHI valued at ${position_value:.2f}")
            except Exception as e:
