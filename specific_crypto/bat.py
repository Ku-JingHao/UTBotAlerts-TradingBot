...
ALPACA_API_KEY = "PK5SGXVVA78FOG0A4OCJ"
ALPACA_SECRET_KEY = "QWAeQCmkURkQF7RqGNVN1oL4IJ7Kb7NKTLwLmQPr"
    ...
    if trade_history:
        ...
        if current_position > 0:
            ...
            try:
                ...
                logger.info(f"Open position  : {current_position} BAT valued at ${position_value:.2f}")
            except Exception as e:
